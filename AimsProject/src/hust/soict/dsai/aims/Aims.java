...
public class Aims {
  ...
  public static void storeMenu(Scanner scanner) {
    ...
    while (!back) {
      ...
      System.out.println("5. Search media by ID");
      System.out.println("6. Sort media by title");
      System.out.println("7. Sort media by cost");
      System.out.println("0. Back");
      System.out.println("--------------------------------");
      System.out.println("Please choose a number: 0-1-2-3-4-5-6-7");
      int option = scanner.nextInt();
      scanner.nextLine();
      switch (option) {
        case 0:
        ...
        case 4:
          ...
          break;
        case 5:
          System.out.println("Enter the ID of the media (type 0 to stop): ");
          ...
          Media mediaByID = store.searchByID(id);
          if (mediaByID != null) {
            clearConsole();
            System.out.println("Details: ");
            System.out.println(mediaByID);
            mediaDetailsMenu(scanner, mediaByID);
          } else {
            System.out.println("***MEDIA NOT FOUND***");
          }
          break;
        case 6:
          store.sortMediaByTitle();
          clearConsole();
          System.out.println("Media sorted by title.");
          break;
        case 7:
          store.sortMediaByCost();
          clearConsole();
