...
import AimsProject.src.hust.soict.dsai.aims.screen.controller.AddBookScreenController;
...
public class AddBookToStoreScreen extends JFrame {
            ...
            public void run() {
                try {
                    FXMLLoader loader = new FXMLLoader(
                            getClass().getResource("/hust/soict/cybersec/aims/screen/view/addBook.fxml"));
    ...
    public void refreshAddBookScreen() {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                try {
