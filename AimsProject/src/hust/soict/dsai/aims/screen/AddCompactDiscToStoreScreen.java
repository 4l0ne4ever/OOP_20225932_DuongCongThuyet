...
import AimsProject.src.hust.soict.dsai.aims.screen.controller.AddCDScreenController;
...
public class AddCompactDiscToStoreScreen extends JFrame {
            ...
            public void run() {
                try {
                    FXMLLoader loader = new FXMLLoader(
                            getClass().getResource("/hust/soict/cybersec/aims/screen/view/addCD.fxml"));
    ...
    public void refreshAddCDScreen() {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                try {
