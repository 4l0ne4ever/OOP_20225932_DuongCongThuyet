...
import AimsProject.src.hust.soict.dsai.aims.screen.controller.AddDVDScreenController;
...
public class AddDigitalVideoDiscToStoreScreen extends JFrame {
            ...
            public void run() {
                try {
                    FXMLLoader loader = new FXMLLoader(
                            getClass().getResource("/hust/soict/cybersec/aims/screen/view/addDVD.fxml"));
    ...
    public void refreshAddDVDScreen() {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                try {
