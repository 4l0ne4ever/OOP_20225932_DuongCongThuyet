...
import AimsProject.src.hust.soict.dsai.aims.screen.controller.AddTrackScreenController;
...
public class AddTrack extends JFrame {
            ...
            public void run() {
                try {
                    FXMLLoader loader = new FXMLLoader(
                            getClass().getResource("/hust/soict/cybersec/aims/screen/view/addTracks.fxml"));
    ...
    public void refreshAddTrackScreen() {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                try {
